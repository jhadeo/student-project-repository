"""
Django settings for student_repo project.
...
SECRET_KEY = 'django-insecure-dlb3-rn9)_tmcu*&^fa4nvj$z)_vs+3ep7)#6rc2qfh_(%n99f'
...
ROOT_URLCONF = 'student_repo.urls'
...
WSGI_APPLICATION = 'student_repo.wsgi.application'
...
# Media files (uploads)
# During development we serve media files from MEDIA_ROOT at MEDIA_URL.
MEDIA_URL = '/media/'
